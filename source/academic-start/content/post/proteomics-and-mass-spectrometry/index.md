---
title: "Next-Generation Proteomics and Mass Spectrometry: A Technical Reference"
subtitle: "From molecular biology and instrumentation to computational analysis"
summary: "A working reference for quantitative scientists moving from transcriptomics into modern proteomics and mass spectrometry."
authors:
  - admin
tags:
  - Proteomics
...
toc: true
math: true
external_link: "/notes/proteomics-and-mass-spectrometry/"
---

{{% callout note %}}
This article also has an [enhanced report layout](/notes/proteomics-and-mass-spectrometry/) with a table of contents, diagrams, callouts, and comparison cards.
{{% /callout %}}
...
* **SCoPE-MS:** Employs isobaric multiplexing tags (such as TMT) where one channel is occupied by a "carrier" channel (e.g., $200 \text{ cells}$) to provide a signal booster that overcomes the detection threshold of the mass spectrometer, while other channels contain single cells.
...
* **Olink:** Employs the **Proximity Extension Assay (PEA)**. Two antibodies, each conjugated to a unique single-stranded DNA oligonucleotide, bind to different epitopes on the same target protein. This brings the DNA strands into close proximity, allowing them to hybridize, undergo enzymatic extension, and be amplified via qPCR or NGS. PEA provides extreme specificity, avoiding the cross-reactivity issues of traditional multiplex ELISAs.
